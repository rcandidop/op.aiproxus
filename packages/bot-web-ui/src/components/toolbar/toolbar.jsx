...
const WorkspaceGroup = ({
    ...
    <div className='toolbar__group toolbar__group-btn'>
        ...
        <IconButton
            ...
            iconOnClick={() => onZoomInOutClick(true)}
        />
        <IconButton
            popover_message={localize('Zoom out')}
            icon='IcZoomOut'
            icon_id='db-toolbar__zoom-out'
            iconOnClick={() => onZoomInOutClick(false)}
        /> */}
    </div>
);
            ...
            {is_mobile ? (
                <div className='toolbar'>
                    <div className='toolbar__section'>
                        ...
                        >
                            <Icon icon='IcFolderOpenFilled' color='active' size={16} />
                            {localize('Load')}
                        </button>
                        {/* button_id='db-toolbar__import-button--mobile' button_classname='toolbar__btn--icon'
